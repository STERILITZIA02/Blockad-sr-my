...
function formatScript(script, context) {
  const scriptFile =
    script.engine === "youtube" ? "youtube-response.js" : "blockad-router.js";
  const parts = [
    `type=http-response`,
  ...
  parts.push(`timeout=${script.engine === "youtube" ? 10 : 5}`);
...
function moduleHeader(name, description, context) {
  return [
    ...
    "#!category=去广告",
    "",
    "# GENERATED FILE — 请修改 config/apps.mjs 后重新构建。",
