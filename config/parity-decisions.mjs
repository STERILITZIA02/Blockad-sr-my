...
export const legacyCoverage = Object.freeze({
  ...
  "bilibili": {
    components: ["bilibili"],
    disposition: "replaced",
    note: "保留开屏、推荐流、直播/动态显式广告；不修改会员或播放地址。",
  },
});
...
export const legacyDecisionOverrides = Object.freeze({
  "YOUKU": {
    disposition: "unsafe",
    note: "按视频 URL 参数猜测广告，可能误伤正片或播放回退。",
  },
  "eleme": {
    disposition: "unsafe",
  ...
  "Meituan-Dianping": {
    disposition: "unsafe",
    note: "旧规则大多按共享 CDN 目录或图片尺寸判断；仅在找到精确业务接口后迁移。",
  },
  "Tencent Video": {
    disposition: "unsafe",
  ...
  "zhibo8": {
    disposition: "unsafe",
    note: "活动配置不是广告专用接口，另一路径只匹配漂移 IP。",
  },
  "zhuishushenqi": {
    disposition: "partial-archive",
