...
export const apps = [
  ...
  },
  {
    ...
    rewrites: [
      {
        comment: "GDT 广告拉取/点击；只清空广告载荷，不整域断开 SDK",
        pattern: re`^https:\/\/(?:mi|v2mi|win)\.gdt\.qq\.com\/gdt_(?:mview|view|click)\.fcg(?:\?|$)`,
        action: "reject-dict",
      },
      {
        comment: "腾讯新闻开屏",
  ...
  },
  {
    id: "douyin",
    name: "抖音",
    description: "仅处理穿山甲/Gromore 精确广告载荷与专用素材；不解密抖音主业务 feed、评论、发布、搜索或直播域名。",
    unified: true,
    rules: [
    ...
    rewrites: [
      {
        comment: "穿山甲广告拉取与配置；保持 SDK 握手域可连接，避免断连重试",
        pattern: re`^https:\/\/api-access\.pangolin-sdk-toutiao(?:[1-5]|-b)?\.com\/api\/ad\/union\/sdk\/(?:get_ads|settings)\/`,
        action: "reject-dict",
      },
      {
        comment: "穿山甲备用广告拉取与配置；仅匹配广告载荷路径",
        pattern: re`^https:\/\/api\.pangolin-sdk-toutiao(?:[1-5]|-b)?\.com\/api\/ad\/union\/sdk\/(?:get_ads|settings)\/`,
        action: "reject-dict",
      },
      {
      ...
      {
        comment: "穿山甲广告落地页包；不阻断 SDK 配置或遥测连接",
        pattern: re`^https:\/\/ether-pack\.pangolin-sdk-toutiao\.com\/union\/endcard(?:\/|$)`,
        action: "reject-200",
      },
      {
        comment: "穿山甲 sf3 明确广告渲染素材",
        pattern: re`^https:\/\/sf3-fe-tos\.pglstatp-toutiao\.com\/obj\/ad-pattern(?:\/|$)`,
        action: "reject-200",
      },
      {
        comment: "穿山甲 sf6 明确广告渲染素材",
        pattern: re`^https:\/\/sf6-fe-tos\.pglstatp-toutiao\.com\/obj\/ad-pattern(?:\/|$)`,
        action: "reject-200",
      },
    ],
    scripts: [],
    mitm: [
      ...
      "api.pangolin-sdk-toutiao-b.com",
      "api.pangolin-sdk-toutiao1.com",
      "api.pangolin-sdk-toutiao2.com",
      "api.pangolin-sdk-toutiao3.com",
      "api.pangolin-sdk-toutiao4.com",
      "api.pangolin-sdk-toutiao5.com",
  ...
  },
  {
    id: "fanqie",
    name: "番茄小说",
    description: "章末/激励广告 SDK 的精确载荷和专用素材；不整域断开 SDK，不解密共享字节业务域。",
    unified: true,
    rules: [
      "DOMAIN,ad.zijieapi.com,REJECT",
      "DOMAIN,api.iegadp.qq.com,REJECT",
    ...
    rewrites: [
      {
        comment: "番茄使用的穿山甲广告拉取与配置；不整域断开 SDK",
        pattern: re`^https:\/\/api-access\.pangolin-sdk-toutiao(?:[1-5]|-b)?\.com\/api\/ad\/union\/sdk\/(?:get_ads|settings)\/`,
        action: "reject-dict",
      },
      {
      ...
      {
        comment: "穿山甲 sf3 明确广告渲染素材；不解密共享 pstatp 业务域",
        pattern: re`^https:\/\/sf3-fe-tos\.pglstatp-toutiao\.com\/obj\/ad-pattern(?:\/|$)`,
        action: "reject-200",
      },
      {
        comment: "穿山甲 sf6 明确广告渲染素材；不解密共享 pstatp 业务域",
        pattern: re`^https:\/\/sf6-fe-tos\.pglstatp-toutiao\.com\/obj\/ad-pattern(?:\/|$)`,
        action: "reject-200",
      },
    ],
