...
- 固定版本发行目录：`release/v1.1.1/`
- 166 个 App/功能独立组件：`release/v1.1.1/components/`
- 默认关闭的便利模块：`release/v1.1.1/extras/`
- 可复现构建输入与第三方原始快照：`release/v1.1.1/source/`
- 发行目录 SHA-256：`release/v1.1.1/SHA256SUMS.txt`
- GitHub Release 包：`BlockAd-SR-v1.1.1.zip`
...
`release:build` 会从固定上游快照重建 v1.1.1、生成稳定入口、打包 ZIP 并复核全部
